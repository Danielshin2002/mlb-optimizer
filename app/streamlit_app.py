...
# _render_feedback_widget, _loading_placeholder → moved to utils/components.py
...
# _render_glossary → moved to utils/components.py
...
# _contract_decision, _roster_grade → moved to pages/roster_simulator.py
